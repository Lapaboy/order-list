...
var Orders = function () {
    ...
    _createClass(Orders, [{
        ...
        value: function filter() {
            this.filtered = this.initialState.filter(function (item) {
        ...
        key: "sortInitialStateDesc",
        value: function sortInitialStateDesc() {
            this.initialState = this.initialState.sort(this.sortDesc);
            this.addOrders(this.initialState);
        }
    }, {
        key: "sortInitialStateAsc",
        value: function sortInitialStateAsc() {
            this.initialState = this.initialState.sort(this.sortAsc);
            this.addOrders(this.initialState);
        }
    }, {
        key: "sortFilteredDesc",
        value: function sortFilteredDesc() {
            this.filtered = this.filtered.sort(this.sortDesc);
            this.addOrders(this.filtered);
        }
    }, {
        key: "sortFilteredAsc",
        value: function sortFilteredAsc() {
            this.filtered = this.filtered.sort(this.sortAsc);
            this.addOrders(this.filtered);
        }
    }, {
        key: "showFilteredOrders",
        value: function showFilteredOrders() {
            this.filter();
            this.addOrders(this.filtered);
        }
    }, {
        key: "addOrders",
        value: function addOrders(data) {
        ...
        key: "formatDate",
        value: function formatDate(text) {
            text = text.split('-');
        ...
        key: "sortDesc",
        value: function sortDesc(date1, date2) {
            date1 = date1.checkout_at.split('-');
            date2 = date2.checkout_at.split('-');

            var date3 = new Date(date1[0], date1[1] - 1, date1[2]);
            var date4 = new Date(date2[0], date2[1] - 1, date2[2]);

            return date3 - date4;
        }
    }, {
        key: "sortAsc",
        value: function sortAsc(date1, date2) {
            date1 = date1.checkout_at.split('-');
            date2 = date2.checkout_at.split('-');
...
var _orders = __webpack_require__(0);
...
document.addEventListener("DOMContentLoaded", function () {
    query().then(function (data) {
        ...
        orders = new _orders2.default(data.orders);
    ...
    filterById.addEventListener("change", function () {
        return orders.showFilteredOrders();
    });
